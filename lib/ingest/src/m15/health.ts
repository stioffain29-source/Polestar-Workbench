...
/** Canonical public-releases listing (operational releases since mid-2026). */
export const CENTCOM_SOURCE_URL = "https://www.centcom.mil/MEDIA/PUBLIC-RELEASES/";
/** Legacy press-releases listing — may redirect to PUBLIC-RELEASES. */
export const CENTCOM_PRESS_RELEASES_URL = "https://www.centcom.mil/MEDIA/PRESS-RELEASES/";
/** Primary live listing path (alias of CENTCOM_SOURCE_URL). */
export const CENTCOM_PUBLIC_RELEASES_URL = CENTCOM_SOURCE_URL;
/** Official press-release RSS — often empty after releases moved to PUBLIC-RELEASES HTML. */
...
/** Primary live listing when centcom.mil HTML + ContentType=2 RSS are empty/blocked. */
export const CENTCOM_GOOGLE_NEWS_BROAD_RSS_URL =
  "https://news.google.com/rss/search?q=" +
  encodeURIComponent("site:centcom.mil when:30d") +
  "&hl=en-US&gl=US&ceid=US:en";
