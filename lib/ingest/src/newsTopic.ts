...
const OUT_OF_REGION: { token: string; canonical: string }[] = [
  ...
  // --- Generated: every remaining world country/territory not tracked by
  // any monitor config, so a future foreign wire story cannot slip through
  // just because its specific country was never manually added here (the
  // Greece/Ceuta class of bug). Regenerate via gen_out_of_region.py if the
  // tracked-country set in topicConfigs.ts changes.
  { token: "afghanistan", canonical: "Afghanistan" },
  { token: "albania", canonical: "Albania" },
  { token: "andorra", canonical: "Andorra" },
  { token: "antigua and barbuda", canonical: "Antigua and Barbuda" },
  { token: "armenia", canonical: "Armenia" },
  { token: "austria", canonical: "Austria" },
  { token: "azerbaijan", canonical: "Azerbaijan" },
  { token: "bahamas", canonical: "Bahamas" },
  { token: "barbados", canonical: "Barbados" },
  { token: "belarus", canonical: "Belarus" },
  { token: "belgium", canonical: "Belgium" },
  { token: "belize", canonical: "Belize" },
  { token: "benin", canonical: "Benin" },
  { token: "bhutan", canonical: "Bhutan" },
  { token: "bolivia", canonical: "Bolivia" },
  { token: "bosnia", canonical: "Bosnia" },
  { token: "botswana", canonical: "Botswana" },
  { token: "bulgaria", canonical: "Bulgaria" },
  { token: "burkina faso", canonical: "Burkina Faso" },
  { token: "burundi", canonical: "Burundi" },
  { token: "cabo verde", canonical: "Cabo Verde" },
  { token: "cambodia", canonical: "Cambodia" },
  { token: "catalonia", canonical: "Catalonia" },
  { token: "central african republic", canonical: "Central African Republic" },
  { token: "ceuta", canonical: "Ceuta" },
  { token: "chad", canonical: "Chad" },
  { token: "chechnya", canonical: "Chechnya" },
  { token: "chile", canonical: "Chile" },
  { token: "comoros", canonical: "Comoros" },
  { token: "costa rica", canonical: "Costa Rica" },
  { token: "crimea", canonical: "Crimea" },
  { token: "croatia", canonical: "Croatia" },
  { token: "cyprus", canonical: "Cyprus" },
  { token: "czechia", canonical: "Czechia" },
  { token: "denmark", canonical: "Denmark" },
  { token: "djibouti", canonical: "Djibouti" },
  { token: "dominica", canonical: "Dominica" },
  { token: "dominican republic", canonical: "Dominican Republic" },
  { token: "ecuador", canonical: "Ecuador" },
  { token: "el salvador", canonical: "El Salvador" },
  { token: "equatorial guinea", canonical: "Equatorial Guinea" },
  { token: "eritrea", canonical: "Eritrea" },
  { token: "estonia", canonical: "Estonia" },
  { token: "eswatini", canonical: "Eswatini" },
  { token: "fiji", canonical: "Fiji" },
  { token: "finland", canonical: "Finland" },
  { token: "gabon", canonical: "Gabon" },
  { token: "gambia", canonical: "Gambia" },
  { token: "gaza", canonical: "Gaza" },
  { token: "georgia", canonical: "Georgia" },
  { token: "greece", canonical: "Greece" },
  { token: "greenland", canonical: "Greenland" },
  { token: "grenada", canonical: "Grenada" },
  { token: "guatemala", canonical: "Guatemala" },
  { token: "guinea", canonical: "Guinea" },
  { token: "guinea-bissau", canonical: "Guinea-Bissau" },
  { token: "guyana", canonical: "Guyana" },
  { token: "haiti", canonical: "Haiti" },
  { token: "herzegovina", canonical: "Herzegovina" },
  { token: "honduras", canonical: "Honduras" },
  { token: "hong kong", canonical: "Hong Kong" },
  { token: "hungary", canonical: "Hungary" },
  { token: "iceland", canonical: "Iceland" },
  { token: "israel", canonical: "Israel" },
  { token: "ivory coast", canonical: "Ivory Coast" },
  { token: "jamaica", canonical: "Jamaica" },
  { token: "jordan", canonical: "Jordan" },
  { token: "kashmir", canonical: "Kashmir" },
  { token: "kazakhstan", canonical: "Kazakhstan" },
  { token: "kiribati", canonical: "Kiribati" },
  { token: "kosovo", canonical: "Kosovo" },
  { token: "kyrgyzstan", canonical: "Kyrgyzstan" },
  { token: "laos", canonical: "Laos" },
  { token: "latvia", canonical: "Latvia" },
  { token: "lebanon", canonical: "Lebanon" },
  { token: "lesotho", canonical: "Lesotho" },
  { token: "liberia", canonical: "Liberia" },
  { token: "liechtenstein", canonical: "Liechtenstein" },
  { token: "lithuania", canonical: "Lithuania" },
  { token: "luxembourg", canonical: "Luxembourg" },
  { token: "macau", canonical: "Macau" },
  { token: "madagascar", canonical: "Madagascar" },
  { token: "malawi", canonical: "Malawi" },
  { token: "maldives", canonical: "Maldives" },
  { token: "mali", canonical: "Mali" },
  { token: "malta", canonical: "Malta" },
  { token: "marshall islands", canonical: "Marshall Islands" },
  { token: "mauritania", canonical: "Mauritania" },
  { token: "mauritius", canonical: "Mauritius" },
  { token: "melilla", canonical: "Melilla" },
  { token: "micronesia", canonical: "Micronesia" },
  { token: "moldova", canonical: "Moldova" },
  { token: "monaco", canonical: "Monaco" },
  { token: "montenegro", canonical: "Montenegro" },
  { token: "namibia", canonical: "Namibia" },
  { token: "nauru", canonical: "Nauru" },
  { token: "netherlands", canonical: "Netherlands" },
  { token: "nicaragua", canonical: "Nicaragua" },
  { token: "north korea", canonical: "North Korea" },
  { token: "north macedonia", canonical: "North Macedonia" },
  { token: "norway", canonical: "Norway" },
  { token: "palau", canonical: "Palau" },
  { token: "palestine", canonical: "Palestine" },
  { token: "panama", canonical: "Panama" },
  { token: "paraguay", canonical: "Paraguay" },
  { token: "peru", canonical: "Peru" },
  { token: "puerto rico", canonical: "Puerto Rico" },
  { token: "romania", canonical: "Romania" },
  { token: "rwanda", canonical: "Rwanda" },
  { token: "samoa", canonical: "Samoa" },
  { token: "san marino", canonical: "San Marino" },
  { token: "serbia", canonical: "Serbia" },
  { token: "seychelles", canonical: "Seychelles" },
  { token: "sierra leone", canonical: "Sierra Leone" },
  { token: "slovakia", canonical: "Slovakia" },
  { token: "slovenia", canonical: "Slovenia" },
  { token: "solomon islands", canonical: "Solomon Islands" },
  { token: "south sudan", canonical: "South Sudan" },
  { token: "suriname", canonical: "Suriname" },
  { token: "sweden", canonical: "Sweden" },
  { token: "switzerland", canonical: "Switzerland" },
  { token: "syria", canonical: "Syria" },
  { token: "taiwan", canonical: "Taiwan" },
  { token: "tajikistan", canonical: "Tajikistan" },
  { token: "tibet", canonical: "Tibet" },
  { token: "togo", canonical: "Togo" },
  { token: "tonga", canonical: "Tonga" },
  { token: "trinidad and tobago", canonical: "Trinidad and Tobago" },
  { token: "turkmenistan", canonical: "Turkmenistan" },
  { token: "tuvalu", canonical: "Tuvalu" },
  { token: "uruguay", canonical: "Uruguay" },
  { token: "uzbekistan", canonical: "Uzbekistan" },
  { token: "vanuatu", canonical: "Vanuatu" },
  { token: "vatican", canonical: "Vatican" },
  { token: "west bank", canonical: "West Bank" },
  { token: "yemen", canonical: "Yemen" },
];
