...
export const COUNTRY_ALIASES: CountryAlias[] = [
  ...
  { canonical: "Bangladesh", aliases: ["bangladesh", "bangladeshi", "dhaka", "chittagong", "chattogram", "bkmea", "bpdb", "desco", "gazipur", "brahmanbaria", "sylhet", "khulna", "jessore", "narayanganj", "rajshahi", "barisal", "mymensingh", "ctg", "comilla", "cumilla", "bogura", "rmg", "nasrul", "berc", "petrobangla", "rangpur", "savar", "ashulia", "tongi"] },
  { canonical: "Sri Lanka", aliases: ["sri lanka", "sri lankan", "colombo", "ceylon", "ceb", "sajith", "kandy", "jaffna"] },
  { canonical: "Nepal", aliases: ["nepal", "nepali", "kathmandu", "nea", "ghising", "chitwan", "pokhara", "biratnagar", "lalitpur", "bhaktapur", "butwal", "dharan"] },
...
const CONFLICT_ALIASES: CountryAlias[] = [
  ...
  { canonical: "Bhutan", aliases: ["bhutan", "bhutanese", "thimphu"] },
  { canonical: "Maldives", aliases: ["maldives", "maldivian", "malé", "male"] },
  ...
  { canonical: "Brunei", aliases: ["brunei", "bandar seri begawan"] },
  { canonical: "Timor-Leste", aliases: ["timor-leste", "timor leste", "east timor", "dili"] },
  { canonical: "Fiji", aliases: ["fiji", "fijian", "suva"] },
  { canonical: "Mongolia", aliases: ["mongolia", "mongolian", "ulaanbaatar"] },
  { canonical: "Japan", aliases: ["japan", "japanese", "tokyo", "okinawa"] },
  { canonical: "South Korea", aliases: ["south korea", "korean", "seoul"] },
  { canonical: "Taiwan", aliases: ["taiwan", "taiwanese", "taipei"] },
  { canonical: "China", aliases: ["china", "chinese", "prc", "mainland china", "xinjiang", "beijing", "shanghai", "guangzhou", "shenzhen", "wuhan", "chengdu", "中国"] },
  { canonical: "Syria", aliases: ["syria", "syrian", "damascus", "aleppo", "idlib", "homs", "latakia", "deir ez-zor", "hasakah"] },
  { canonical: "Iraq", aliases: ["iraq", "iraqi", "baghdad", "mosul", "kirkuk", "erbil"] },
  { canonical: "Iran", aliases: ["iran", "iranian", "tehran"] },
  ...
  { canonical: "Yemen", aliases: ["yemen", "yemeni", "sanaa", "aden", "houthi"] },
  ...
  { canonical: "United Arab Emirates", aliases: ["united arab emirates", "uae", "emirati", "abu dhabi", "dubai"] },
  { canonical: "Oman", aliases: ["oman", "omani", "muscat"] },
  { canonical: "Qatar", aliases: ["qatar", "qatari", "doha"] },
  { canonical: "Bahrain", aliases: ["bahrain", "bahraini", "manama"] },
  { canonical: "Kuwait", aliases: ["kuwait", "kuwaiti", "kuwait city"] },
];
...
export const CONFLICT_CONFIG: NewsTopicConfig = {
  ...
  feeds: [
    ...
    { label: "Syria conflict", q: `(Syria OR Syrian OR Damascus OR Aleppo OR Idlib OR Homs OR Latakia OR "Deir ez-Zor" OR Hasakah) (airstrike OR shelling OR fighting OR clash OR offensive OR attack OR ambush OR bombing OR drone OR missile OR insurgent OR militia OR "armed group") when:14d`, defaultCountry: "Syria" },
    { label: "Syria security operations", q: `(Syria OR Syrian OR Damascus OR Aleppo OR Idlib OR Homs OR Latakia OR "Deir ez-Zor" OR Hasakah OR Raqqa OR Suwayda) (SDF OR HTS OR "Syrian army" OR "security forces" OR raid OR checkpoint OR incursion OR "ceasefire violation" OR clashes OR shelling OR airstrike OR ambush OR bombing) when:14d`, defaultCountry: "Syria" },
    { label: "Iraq conflict", q: `(Iraq OR Baghdad OR Mosul OR Kirkuk OR Erbil) (airstrike OR shelling OR fighting OR clash OR attack OR ambush OR bombing OR drone OR missile OR insurgent OR militia OR "armed group") when:14d`, defaultCountry: "Iraq" },
    { label: "Levant conflict", q: `(Israel OR Gaza OR "West Bank" OR Lebanon OR Beirut OR Yemen OR Houthi) (airstrike OR shelling OR fighting OR clash OR attack OR bombing OR drone OR missile OR militant OR militia) when:14d`, defaultCountry: "Unknown" },
  ],
  allow: [
    "armed clash",
    "armed clashes",
