...
export const ListSocialWatchItemsResponseItem = zod.object({
  ...
  "captionEn": zod.string().nullish().describe('Faithful English translation of a non-English (Bahasa) caption. NULL until translated; clients prefer this and fall back to caption.'),
 ...
 */
export const CreateSocialWatchItemBody = zod.object({
  "platform": zod.enum(['instagram', 'telegram']).describe('The platform the post was seen on.'),
  "url": zod.string().describe('Public URL of the post.'),
  "caption": zod.string().describe('The post text \/ caption, pasted verbatim. Sanitised server-side.'),
  "actor": zod.string().optional().describe('Organiser \/ account (defaults to \"KAMMI Pusat\").'),
  "channel": zod.string().optional().describe('Account handle the post was read from (defaults per platform).'),
  ...
  "city": zod.string().optional().describe('City (defaults to Jakarta). Overrides the parsed city when provided.'),
