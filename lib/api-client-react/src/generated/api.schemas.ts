...
export interface DbPortsWarning {
  code: DbPortsWarningCode;
  message: string;
}
...
export type CountryReportSectionOverridesThemeParagraphs = {[key: string]: string};

export type CountryReportSectionOverridesActionGroups = {[key: string]: string};
