...
export default function Countries() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-5">
      <div>
        <div className="text-xs font-sans uppercase tracking-widest text-muted-foreground">Country Reports</div>
        <h1 className="text-3xl font-serif font-bold text-primary uppercase tracking-tight mt-1">Country Picture</h1>
        <p className="text-muted-foreground font-sans mt-1 text-sm">Long form intelligence picture by country of interest</p>
      </div>
      {isLoading ? (
