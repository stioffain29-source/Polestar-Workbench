...
**How to apply:** Any tuning must replay against ALL relevant production rows and inspect every flip. Bump RELEVANCE_RULE_VERSION so persisted rows re-evaluate. Keep entertainment rejection ahead of security overrides.
