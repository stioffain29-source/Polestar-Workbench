...
- Regional Highlights is a required Fuel Watch section; replace generic filler with evidence-led regional analysis, never suppress the section as the “fix.”
  **Why:** the owner explicitly rejected removal after asking for the section’s content to be corrected.
